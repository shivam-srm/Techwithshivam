...
export default function Work() {
    return (
        <section id="work" className="min-h-screen py-10 relative overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="container mx-auto px-6 relative z-10 w-full h-full flex items-center justify-center gap-8 md:gap-16">
                ...
                <div className="md:hidden absolute top-4 left-0 w-full text-center">
